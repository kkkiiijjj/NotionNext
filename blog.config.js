...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Forforevery', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一名热爱创造的技术小白大学生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-seven-alpha-69.vercel.app/', // 网站地址
